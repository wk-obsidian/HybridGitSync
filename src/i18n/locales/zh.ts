export default {
  ...
  'ui.cancel': '取消',
  'ui.processing': '处理中...',
  'ui.mergeConflict': '合并冲突',
  'ui.mergeInstructions': '冲突标记已写入文件。',
  'ui.mergeInstructionsDetail': '请编辑文件解决冲突，然后点击"完成"。',
  'ui.openFile': '打开文件',
  'ui.mergeWaiting': '等待您编辑文件...',
  'ui.mergeDone': '完成',
  'ui.fileNotFound': '文件未找到',
  'ui.conflictMarkersStillExist': '冲突标记仍然存在，请先编辑文件。',
  'ui.noChanges': '无变更',
  'ui.noCommits': '无提交记录',
